...
<qgis version="3.10.10-A Coruña" simplifyMaxScale="1" labelsEnabled="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" readOnly="0" minScale="1e+08" simplifyAlgorithm="0" maxScale="0" simplifyDrawingHints="1" simplifyLocal="1" simplifyDrawingTol="1">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontWordSpacing="0" fontSize="8" fontSizeUnit="Point" blendMode="0" isExpression="1" fieldName="coalesce(round(orf_crest_level, 2), 'NULL')" fontFamily="MS Gothic" multilineHeight="1" textOrientation="horizontal" fontWeight="50" textColor="51,160,44,255" fontKerning="1" fontItalic="0" previewBkgrdColor="255,255,255,255" namedStyle="Regular" fontStrikeout="0" textOpacity="1" fontCapitals="0" fontUnderline="0" useSubstitutions="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontLetterSpacing="0">
