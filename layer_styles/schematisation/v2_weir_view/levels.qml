...
<qgis hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyAlgorithm="0" simplifyMaxScale="1" version="3.10.10-A Coruña" simplifyDrawingTol="1" minScale="1e+08" simplifyLocal="1" maxScale="0" readOnly="0" simplifyDrawingHints="1">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontLetterSpacing="0" textColor="227,26,28,255" textOrientation="horizontal" blendMode="0" fieldName="coalesce(round(weir_crest_level, 2), 'NULL')" fontWordSpacing="0" fontUnderline="0" previewBkgrdColor="255,255,255,255" fontItalic="0" fontStrikeout="0" fontWeight="50" fontSizeUnit="Point" namedStyle="Regular" fontSize="8" multilineHeight="1" textOpacity="1" useSubstitutions="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontKerning="1" isExpression="1" fontCapitals="0" fontFamily="MS Gothic">
  ...
  <aliases>
    ...
    <alias field="weir_id" index="1" name="id"/>
    <alias field="weir_display_name" index="2" name="display_name"/>
    <alias field="weir_code" index="3" name="code"/>
    <alias field="weir_crest_level" index="4" name="crest_level"/>
    <alias field="weir_crest_type" index="5" name="crest_type"/>
    <alias field="weir_cross_section_definition_id" index="6" name="Cross_section_definition_id"/>
    <alias field="weir_sewerage" index="7" name="sewerage"/>
    <alias field="weir_discharge_coefficient_positive" index="8" name="discharge_coefficient_positive"/>
    <alias field="weir_discharge_coefficient_negative" index="9" name="discharge_coefficient_negative"/>
    <alias field="weir_external" index="10" name="external"/>
    <alias field="weir_zoom_category" index="11" name="zoom_category"/>
    <alias field="weir_friction_value" index="12" name="friction_value"/>
    <alias field="weir_friction_type" index="13" name="friction_type"/>
    <alias field="weir_connection_node_start_id" index="14" name="connection_node_start_id"/>
    <alias field="weir_connection_node_end_id" index="15" name="connection_node_end_id"/>
    <alias field="def_id" index="16" name="id"/>
    <alias field="def_shape" index="17" name="shape"/>
    <alias field="def_width" index="18" name="width"/>
    <alias field="def_height" index="19" name="height"/>
    <alias field="def_code" index="20" name="code"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint field="weir_id" exp_strength="0" constraints="1" notnull_strength="2" unique_strength="0"/>
    <constraint field="weir_display_name" exp_strength="0" constraints="1" notnull_strength="2" unique_strength="0"/>
    <constraint field="weir_code" exp_strength="0" constraints="1" notnull_strength="2" unique_strength="0"/>
    <constraint field="weir_crest_level" exp_strength="0" constraints="1" notnull_strength="2" unique_strength="0"/>
    <constraint field="weir_crest_type" exp_strength="0" constraints="1" notnull_strength="2" unique_strength="0"/>
    <constraint field="weir_cross_section_definition_id" exp_strength="0" constraints="1" notnull_strength="2" unique_strength="0"/>
    <constraint field="weir_sewerage" exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint field="weir_discharge_coefficient_positive" exp_strength="0" constraints="1" notnull_strength="2" unique_strength="0"/>
    <constraint field="weir_discharge_coefficient_negative" exp_strength="0" constraints="1" notnull_strength="2" unique_strength="0"/>
    <constraint field="weir_external" exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint field="weir_zoom_category" exp_strength="0" constraints="1" notnull_strength="2" unique_strength="0"/>
    <constraint field="weir_friction_value" exp_strength="0" constraints="1" notnull_strength="2" unique_strength="0"/>
    <constraint field="weir_friction_type" exp_strength="0" constraints="1" notnull_strength="2" unique_strength="0"/>
    <constraint field="weir_connection_node_start_id" exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint field="weir_connection_node_end_id" exp_strength="0" constraints="0" notnull_strength="0" unique_strength="0"/>
  ...
  <attributetableconfig sortExpression="&quot;weir_discharge_coefficient_positive&quot;" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      <column hidden="0" width="-1" name="ROWID" type="field"/>
      <column hidden="0" width="-1" name="weir_id" type="field"/>
      <column hidden="0" width="-1" name="weir_display_name" type="field"/>
      <column hidden="0" width="-1" name="weir_code" type="field"/>
      <column hidden="0" width="-1" name="weir_crest_level" type="field"/>
      <column hidden="0" width="-1" name="weir_crest_type" type="field"/>
      <column hidden="0" width="185" name="weir_cross_section_definition_id" type="field"/>
      <column hidden="0" width="-1" name="weir_sewerage" type="field"/>
      <column hidden="0" width="-1" name="weir_discharge_coefficient_positive" type="field"/>
      <column hidden="0" width="-1" name="weir_discharge_coefficient_negative" type="field"/>
      <column hidden="0" width="-1" name="weir_external" type="field"/>
      <column hidden="0" width="-1" name="weir_zoom_category" type="field"/>
      <column hidden="0" width="-1" name="weir_friction_value" type="field"/>
      <column hidden="0" width="-1" name="weir_friction_type" type="field"/>
      <column hidden="0" width="-1" name="weir_connection_node_start_id" type="field"/>
      <column hidden="0" width="-1" name="weir_connection_node_end_id" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer visibilityExpressionEnabled="0" groupBox="0" columnCount="1" name="Weir view" showLabel="1" visibilityExpression="">
      <attributeEditorContainer visibilityExpressionEnabled="0" groupBox="1" columnCount="1" name="General" showLabel="1" visibilityExpression="">
        <attributeEditorField index="1" name="weir_id" showLabel="1"/>
        <attributeEditorField index="2" name="weir_display_name" showLabel="1"/>
        <attributeEditorField index="3" name="weir_code" showLabel="1"/>
      ...
      <attributeEditorContainer visibilityExpressionEnabled="0" groupBox="1" columnCount="1" name="Characteristics" showLabel="1" visibilityExpression="">
        <attributeEditorField index="4" name="weir_crest_level" showLabel="1"/>
        <attributeEditorField index="5" name="weir_crest_type" showLabel="1"/>
        <attributeEditorField index="8" name="weir_discharge_coefficient_positive" showLabel="1"/>
        <attributeEditorField index="9" name="weir_discharge_coefficient_negative" showLabel="1"/>
        <attributeEditorField index="12" name="weir_friction_value" showLabel="1"/>
        <attributeEditorField index="13" name="weir_friction_type" showLabel="1"/>
      </attributeEditorContainer>
      <attributeEditorContainer visibilityExpressionEnabled="0" groupBox="1" columnCount="1" name="Cross section" showLabel="1" visibilityExpression="">
        <attributeEditorField index="6" name="weir_cross_section_definition_id" showLabel="1"/>
        <attributeEditorField index="20" name="def_code" showLabel="1"/>
        <attributeEditorField index="17" name="def_shape" showLabel="1"/>
        <attributeEditorField index="18" name="def_width" showLabel="1"/>
        <attributeEditorField index="19" name="def_height" showLabel="1"/>
      </attributeEditorContainer>
      <attributeEditorContainer visibilityExpressionEnabled="0" groupBox="1" columnCount="1" name="Visualization" showLabel="1" visibilityExpression="">
        <attributeEditorField index="7" name="weir_sewerage" showLabel="1"/>
        <attributeEditorField index="10" name="weir_external" showLabel="1"/>
        <attributeEditorField index="11" name="weir_zoom_category" showLabel="1"/>
      </attributeEditorContainer>
      <attributeEditorContainer visibilityExpressionEnabled="0" groupBox="1" columnCount="1" name="Connection nodes" showLabel="1" visibilityExpression="">
        <attributeEditorField index="14" name="weir_connection_node_start_id" showLabel="1"/>
        <attributeEditorField index="15" name="weir_connection_node_end_id" showLabel="1"/>
      </attributeEditorContainer>
    </attributeEditorContainer>
  </attributeEditorForm>
  <editable>
