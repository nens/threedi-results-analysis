...
<qgis readOnly="0" labelsEnabled="0" simplifyAlgorithm="0" simplifyMaxScale="1" version="3.10.10-A Coruña" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="1e+08" simplifyDrawingTol="1" simplifyDrawingHints="1" maxScale="0" simplifyLocal="1">
  <flags>
            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="enabled">
                  ...
                  <Option value="weir_discharge_coefficient_negative = 0" type="QString" name="expression"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="enabled">
                  <Option value="true" type="bool" name="active"/>
                  <Option value="weir_discharge_coefficient_positive > 0&#xd;&#xa;AND weir_discharge_coefficient_negative = 0" type="QString" name="expression"/>
                  <Option value="3" type="int" name="type"/>
                </Option>
                <Option type="Map" name="offset">
                  <Option value="false" type="bool" name="active"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="enabled">
                  <Option value="true" type="bool" name="active"/>
                  <Option value="weir_discharge_coefficient_positive = 0" type="QString" name="expression"/>
                  <Option value="3" type="int" name="type"/>
                </Option>
                <Option type="Map" name="offset">
                  <Option value="false" type="bool" name="active"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="enabled">
                  <Option value="true" type="bool" name="active"/>
                  <Option value="weir_discharge_coefficient_negative > 0&#xd;&#xa;AND weir_discharge_coefficient_positive = 0" type="QString" name="expression"/>
                  <Option value="3" type="int" name="type"/>
                </Option>
                <Option type="Map" name="offset">
                  <Option value="false" type="bool" name="active"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fieldName="coalesce(round(weir_crest_level, 2), 'NULL')" multilineHeight="1" fontKerning="1" fontSizeUnit="Point" fontFamily="MS Shell Dlg 2" fontUnderline="0" fontLetterSpacing="0" fontItalic="0" blendMode="0" namedStyle="Standaard" previewBkgrdColor="255,255,255,255" textColor="227,26,28,255" fontWordSpacing="0" isExpression="1" fontWeight="50" fontCapitals="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" fontSize="8" textOpacity="1" fontStrikeout="0" textOrientation="horizontal">
