...
<qgis version="3.10.10-A Coruña" simplifyMaxScale="1" labelsEnabled="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" readOnly="0" minScale="1e+08" simplifyAlgorithm="0" maxScale="0" simplifyDrawingHints="1" simplifyLocal="1" simplifyDrawingTol="1">
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="enabled" type="Map">
                  ...
                  <Option name="expression" type="QString" value="weir_discharge_coefficient_negative = 0"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="enabled" type="Map">
                  <Option name="active" type="bool" value="true"/>
                  <Option name="expression" type="QString" value="weir_discharge_coefficient_positive > 0&#xd;&#xa;AND weir_discharge_coefficient_negative = 0"/>
                  <Option name="type" type="int" value="3"/>
                </Option>
                <Option name="offset" type="Map">
                  <Option name="active" type="bool" value="false"/>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="2: Circle" type="QString" value="2"/>
              </Option>
              <Option type="Map">
  ...
  <defaults>
    ...
    <default expression="if(maximum(weir_id) is null,1, maximum(weir_id)+1)" field="weir_id" applyOnUpdate="0"/>
    <default expression="'new'" field="weir_display_name" applyOnUpdate="0"/>
    <default expression="'new'" field="weir_code" applyOnUpdate="0"/>
    <default expression="" field="weir_crest_level" applyOnUpdate="0"/>
    <default expression="4" field="weir_crest_type" applyOnUpdate="0"/>
    <default expression="" field="weir_cross_section_definition_id" applyOnUpdate="0"/>
    <default expression="" field="weir_sewerage" applyOnUpdate="0"/>
    <default expression="0.8" field="weir_discharge_coefficient_positive" applyOnUpdate="0"/>
    <default expression="0.8" field="weir_discharge_coefficient_negative" applyOnUpdate="0"/>
    <default expression="1" field="weir_external" applyOnUpdate="0"/>
    <default expression="2" field="weir_zoom_category" applyOnUpdate="0"/>
    <default expression="0.02" field="weir_friction_value" applyOnUpdate="0"/>
    <default expression="2" field="weir_friction_type" applyOnUpdate="0"/>
    <default expression="if(aggregate('v2_connection_nodes','min',&quot;id&quot;, intersects($geometry,start_point(geometry(@parent)))) is null,'Created automatically',aggregate('v2_connection_nodes','min',&quot;id&quot;, intersects($geometry,start_point(geometry(@parent)))))" field="weir_connection_node_start_id" applyOnUpdate="0"/>
    <default expression="if(aggregate('v2_connection_nodes','min',&quot;id&quot;, intersects($geometry,end_point(geometry(@parent)))) is null,'Created automatically',aggregate('v2_connection_nodes','min',&quot;id&quot;, intersects($geometry,end_point(geometry(@parent)))))" field="weir_connection_node_end_id" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint constraints="1" unique_strength="0" field="weir_id" notnull_strength="2" exp_strength="0"/>
    <constraint constraints="1" unique_strength="0" field="weir_display_name" notnull_strength="2" exp_strength="0"/>
    <constraint constraints="1" unique_strength="0" field="weir_code" notnull_strength="2" exp_strength="0"/>
    <constraint constraints="1" unique_strength="0" field="weir_crest_level" notnull_strength="2" exp_strength="0"/>
    <constraint constraints="1" unique_strength="0" field="weir_crest_type" notnull_strength="2" exp_strength="0"/>
    <constraint constraints="1" unique_strength="0" field="weir_cross_section_definition_id" notnull_strength="2" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="weir_sewerage" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="1" unique_strength="0" field="weir_discharge_coefficient_positive" notnull_strength="2" exp_strength="0"/>
    <constraint constraints="1" unique_strength="0" field="weir_discharge_coefficient_negative" notnull_strength="2" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="weir_external" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="1" unique_strength="0" field="weir_zoom_category" notnull_strength="2" exp_strength="0"/>
    <constraint constraints="1" unique_strength="0" field="weir_friction_value" notnull_strength="2" exp_strength="0"/>
    <constraint constraints="1" unique_strength="0" field="weir_friction_type" notnull_strength="2" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="weir_connection_node_start_id" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="weir_connection_node_end_id" notnull_strength="0" exp_strength="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer columnCount="1" name="Weir view" visibilityExpression="" groupBox="0" visibilityExpressionEnabled="0" showLabel="1">
