...
<qgis readOnly="0" simplifyLocal="1" labelsEnabled="0" simplifyDrawingTol="1" version="3.10.10-A Coruña" simplifyAlgorithm="0" minScale="1e+08" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyDrawingHints="1" simplifyMaxScale="1">
  ...
  <constraints>
    ...
    <constraint unique_strength="0" constraints="1" field="weir_id" notnull_strength="2" exp_strength="0"/>
    <constraint unique_strength="0" constraints="1" field="weir_display_name" notnull_strength="2" exp_strength="0"/>
    <constraint unique_strength="0" constraints="1" field="weir_code" notnull_strength="2" exp_strength="0"/>
    <constraint unique_strength="0" constraints="1" field="weir_crest_level" notnull_strength="2" exp_strength="0"/>
    <constraint unique_strength="0" constraints="1" field="weir_crest_type" notnull_strength="2" exp_strength="0"/>
    <constraint unique_strength="0" constraints="1" field="weir_cross_section_definition_id" notnull_strength="2" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="weir_sewerage" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="1" field="weir_discharge_coefficient_positive" notnull_strength="2" exp_strength="0"/>
    <constraint unique_strength="0" constraints="1" field="weir_discharge_coefficient_negative" notnull_strength="2" exp_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="weir_external" notnull_strength="0" exp_strength="0"/>
    <constraint unique_strength="0" constraints="1" field="weir_zoom_category" notnull_strength="2" exp_strength="0"/>
    <constraint unique_strength="0" constraints="1" field="weir_friction_value" notnull_strength="2" exp_strength="0"/>
    <constraint unique_strength="0" constraints="1" field="weir_friction_type" notnull_strength="2" exp_strength="0"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" name="weir_cross_section_definition_id" hidden="0" width="185"/>
