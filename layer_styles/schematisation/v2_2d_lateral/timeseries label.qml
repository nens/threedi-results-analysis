...
<qgis simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" minScale="1e+08" simplifyAlgorithm="0" maxScale="0" version="3.10.10-A Coruña" labelsEnabled="1" simplifyMaxScale="1" simplifyDrawingTol="1" readOnly="0" simplifyLocal="1">
  <flags>
    ...
    <symbols>
      <symbol alpha="1" name="0" type="marker" clip_to_extent="1" force_rhr="0">
        <layer pass="0" locked="0" class="SimpleMarker" enabled="1">
          <prop v="180" k="angle"/>
          <prop v="113,111,253,255" k="color"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement yOffset="-3" geometryGeneratorEnabled="0" rotationAngle="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" overrunDistanceUnit="MM" quadOffset="2" offsetUnits="MM" maxCurvedCharAngleIn="25" placement="1" repeatDistanceUnits="MM" maxCurvedCharAngleOut="-25" offsetType="0" distUnits="MM" geometryGenerator="" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" geometryGeneratorType="PointGeometry" centroidWhole="0" centroidInside="0" priority="5" overrunDistance="0" xOffset="1" distMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" dist="0" layerType="PointGeometry" preserveRotation="1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer showLabel="1" groupBox="0" visibilityExpressionEnabled="0" visibilityExpression="" name="General" columnCount="1">
      ...
      <attributeEditorField showLabel="1" name="type" index="0"/>
