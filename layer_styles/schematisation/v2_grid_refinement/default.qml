...
<qgis simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" minScale="1e+08" simplifyAlgorithm="0" maxScale="0" version="3.10.10-A Coruña" labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingTol="1" readOnly="0" simplifyLocal="1">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontKerning="1" isExpression="0" fontLetterSpacing="0" namedStyle="Regular" blendMode="0" fontUnderline="0" fontCapitals="0" fieldName="code" useSubstitutions="0" textColor="0,0,0,255" fontSizeUnit="Point" textOrientation="horizontal" fontItalic="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWordSpacing="0" previewBkgrdColor="255,255,255,255" multilineHeight="1" fontWeight="50" fontSize="8" fontFamily="MS Gothic" fontStrikeout="0" textOpacity="1">
