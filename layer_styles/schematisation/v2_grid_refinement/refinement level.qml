...
<qgis simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" minScale="1e+08" simplifyAlgorithm="0" maxScale="0" version="3.10.10-A Coruña" labelsEnabled="1" simplifyMaxScale="1" simplifyDrawingTol="1" readOnly="0" simplifyLocal="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontKerning="1" isExpression="0" fontLetterSpacing="0" namedStyle="Regular" blendMode="0" fontUnderline="0" fontCapitals="0" fieldName="refinement_level" useSubstitutions="0" textColor="0,0,0,255" fontSizeUnit="Point" textOrientation="horizontal" fontItalic="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWordSpacing="0" previewBkgrdColor="255,255,255,255" multilineHeight="1" fontWeight="50" fontSize="8" fontFamily="MS Gothic" fontStrikeout="0" textOpacity="1">
      ...
      <Option type="Map">
        ...
        <Option name="properties" type="Map">
          <Option name="show" type="Map">
            <Option value="true" name="active" type="bool"/>
            <Option value="refinement_level" name="field" type="QString"/>
  ...
  <aliases>
    <alias field="refinement_level" name="" index="0"/>
  ...
  <defaults>
    <default field="refinement_level" expression="1" applyOnUpdate="0"/>
  ...
  <constraints>
    <constraint field="refinement_level" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="2"/>
  ...
  <constraintExpressions>
    <constraint field="refinement_level" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      <column hidden="0" width="-1" name="refinement_level" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer showLabel="1" groupBox="0" visibilityExpressionEnabled="0" visibilityExpression="" name="General" columnCount="1">
      <attributeEditorField showLabel="1" name="id" index="3"/>
      <attributeEditorField showLabel="1" name="display_name" index="2"/>
      <attributeEditorField showLabel="1" name="code" index="1"/>
      <attributeEditorField showLabel="1" name="refinement_level" index="0"/>
