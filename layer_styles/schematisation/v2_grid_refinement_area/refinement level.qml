...
<qgis styleCategories="AllStyleCategories" simplifyDrawingTol="1" maxScale="0" labelsEnabled="1" simplifyDrawingHints="1" readOnly="0" hasScaleBasedVisibilityFlag="0" version="3.10.10-A Coruña" simplifyMaxScale="1" minScale="1e+08" simplifyLocal="1" simplifyAlgorithm="0">
    ...
    <symbols>
      <symbol name="0" type="fill" clip_to_extent="1" alpha="1" force_rhr="0">
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="lineDistance" type="Map">
                  ...
                  <Option name="expression" type="QString" value="0.7 + (refinement_level-1) * 0.5"/>
        ...
        <layer locked="0" enabled="1" class="LinePatternFill" pass="0">
          ...
          <symbol name="@0@1" type="line" clip_to_extent="1" alpha="1" force_rhr="0">
            <layer locked="0" enabled="1" class="SimpleLine" pass="0">
              <prop v="square" k="capstyle"/>
              <prop v="5;2" k="customdash"/>
              <prop v="3x:0,0,0,0,0,0" k="customdash_map_unit_scale"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement offsetType="0" maxCurvedCharAngleIn="25" rotationAngle="0" geometryGenerator="" geometryGeneratorEnabled="0" distUnits="MM" quadOffset="4" offsetUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" overrunDistance="0" geometryGeneratorType="PointGeometry" dist="0" repeatDistance="0" priority="5" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" centroidWhole="0" centroidInside="0" layerType="PolygonGeometry" xOffset="0" preserveRotation="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" distMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" placement="2" yOffset="0" overrunDistanceUnit="MM"/>
  ...
  <aliases>
    ...
    <alias name="" index="2" field="refinement_level"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer columnCount="1" name="General" visibilityExpression="" groupBox="0" visibilityExpressionEnabled="0" showLabel="1">
      ...
      <attributeEditorField name="refinement_level" index="2" showLabel="1"/>
