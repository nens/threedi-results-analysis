...
<qgis simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" minScale="1e+08" simplifyAlgorithm="0" maxScale="0" version="3.10.10-A Coruña" labelsEnabled="1" simplifyMaxScale="1" simplifyDrawingTol="1" readOnly="0" simplifyLocal="1">
    ...
    <symbols>
      <symbol alpha="1" name="0" type="fill" clip_to_extent="1" force_rhr="0">
        <layer pass="0" locked="0" class="LinePatternFill" enabled="1">
          <prop v="-45" k="angle"/>
          <prop v="121,191,130,255" k="color"/>
          <prop v="0.7" k="distance"/>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="lineDistance" type="Map">
                  ...
                  <Option value="0.7 + (refinement_level-1) * 0.5" name="expression" type="QString"/>
          ...
          <symbol alpha="1" name="@0@0" type="line" clip_to_extent="1" force_rhr="0">
            <layer pass="0" locked="0" class="SimpleLine" enabled="1">
              ...
              <prop v="121,191,130,255" k="line_color"/>
        ...
        <layer pass="0" locked="0" class="SimpleLine" enabled="1">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="17,94,46,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="0.46" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement yOffset="0" geometryGeneratorEnabled="0" rotationAngle="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" overrunDistanceUnit="MM" quadOffset="4" offsetUnits="MM" maxCurvedCharAngleIn="25" placement="2" repeatDistanceUnits="MM" maxCurvedCharAngleOut="-25" offsetType="0" distUnits="MM" geometryGenerator="" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" geometryGeneratorType="PointGeometry" centroidWhole="0" centroidInside="0" priority="5" overrunDistance="0" xOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" dist="0" layerType="PolygonGeometry" preserveRotation="1"/>
  ...
  <aliases>
    ...
    <alias field="refinement_level" name="" index="2"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer showLabel="1" groupBox="0" visibilityExpressionEnabled="0" visibilityExpression="" name="General" columnCount="1">
      ...
      <attributeEditorField showLabel="1" name="refinement_level" index="2"/>
