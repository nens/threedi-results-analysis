...
<qgis simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" minScale="1e+08" simplifyAlgorithm="0" maxScale="0" version="3.10.10-A Coruña" labelsEnabled="1" simplifyMaxScale="1" simplifyDrawingTol="1" readOnly="0" simplifyLocal="1">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 attr="material" enableorderby="0" forceraster="0" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="1" render="true" label="1: sand"/>
      <category symbol="1" value="2" render="true" label="2: clay"/>
      <category symbol="2" value="" render="true" label="Invalid material"/>
    </categories>
    <symbols>
      <symbol alpha="1" name="0" type="line" clip_to_extent="1" force_rhr="0">
        <layer pass="0" locked="0" class="SimpleLine" enabled="1">
          ...
          <prop v="170,91,82,255" k="line_color"/>
      ...
      <symbol alpha="1" name="1" type="line" clip_to_extent="1" force_rhr="0">
        ...
        <layer pass="0" locked="0" class="HashLine" enabled="1">
          ...
          <symbol alpha="1" name="@1@1" type="line" clip_to_extent="1" force_rhr="0">
            <layer pass="0" locked="0" class="SimpleLine" enabled="1">
              <prop v="square" k="capstyle"/>
              <prop v="5;2" k="customdash"/>
              <prop v="3x:0,0,0,0,0,0" k="customdash_map_unit_scale"/>
        ...
        <layer pass="0" locked="0" class="HashLine" enabled="1">
          ...
          <symbol alpha="1" name="@1@2" type="line" clip_to_extent="1" force_rhr="0">
            <layer pass="0" locked="0" class="SimpleLine" enabled="1">
              <prop v="square" k="capstyle"/>
              <prop v="5;2" k="customdash"/>
              <prop v="3x:0,0,0,0,0,0" k="customdash_map_unit_scale"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontKerning="1" isExpression="1" fontLetterSpacing="0" namedStyle="Regular" blendMode="0" fontUnderline="0" fontCapitals="0" fieldName=" format_number(&quot;crest_level&quot; , 2)" useSubstitutions="0" textColor="0,0,0,255" fontSizeUnit="Point" textOrientation="horizontal" fontItalic="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWordSpacing="0" previewBkgrdColor="255,255,255,255" multilineHeight="1" fontWeight="50" fontSize="8" fontFamily="MS Gothic" fontStrikeout="0" textOpacity="1">
      ...
      <placement yOffset="0" geometryGeneratorEnabled="0" rotationAngle="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" overrunDistanceUnit="MM" quadOffset="4" offsetUnits="MM" maxCurvedCharAngleIn="25" placement="2" repeatDistanceUnits="MM" maxCurvedCharAngleOut="-25" offsetType="0" distUnits="MM" geometryGenerator="" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" geometryGeneratorType="PointGeometry" centroidWhole="0" centroidInside="0" priority="5" overrunDistance="0" xOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" dist="0" layerType="LineGeometry" preserveRotation="1"/>
      <rendering scaleMax="0" obstacle="1" upsidedownLabels="0" displayAll="0" minFeatureSize="0" obstacleType="0" limitNumLabels="0" maxNumLabels="2000" fontMaxPixelSize="10000" scaleVisibility="0" fontLimitPixelSize="0" zIndex="0" scaleMin="0" labelPerPart="0" mergeLines="0" obstacleFactor="1" drawLabels="1" fontMinPixelSize="3"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties"/>
  ...
  <DiagramLayerSettings placement="2" priority="0" linePlacementFlags="2" dist="0" showAll="1" obstacle="0" zIndex="0">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties" type="Map">
          <Option name="show" type="Map">
            ...
            <Option value="code" name="field" type="QString"/>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option value="1" name="1: sand" type="QString"/>
              </Option>
              <Option type="Map">
                <Option value="2" name="2: clay" type="QString"/>
              </Option>
            </Option>
          </Option>
        </config>
  ...
  <aliases>
    <alias field="code" name="" index="0"/>
    <alias field="material" name="" index="1"/>
    <alias field="crest_level" name="" index="2"/>
    <alias field="max_breach_depth" name="" index="3"/>
  ...
  <defaults>
    ...
    <default field="max_breach_depth" expression="" applyOnUpdate="0"/>
    <default field="id" expression="if(maximum(id) is null,1, maximum(id)+1)" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    <constraint field="code" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="2"/>
    <constraint field="material" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint field="crest_level" unique_strength="0" exp_strength="0" constraints="1" notnull_strength="2"/>
    <constraint field="max_breach_depth" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="max_breach_depth" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" width="-1" name="crest_level" type="field"/>
      <column hidden="1" width="-1" type="actions"/>
      <column hidden="0" width="-1" name="material" type="field"/>
      <column hidden="0" width="-1" name="max_breach_depth" type="field"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer showLabel="1" groupBox="0" visibilityExpressionEnabled="0" visibilityExpression="" name="General" columnCount="1">
      ...
      <attributeEditorField showLabel="1" name="code" index="0"/>
      <attributeEditorField showLabel="1" name="crest_level" index="2"/>
      <attributeEditorField showLabel="1" name="material" index="1"/>
      <attributeEditorField showLabel="1" name="max_breach_depth" index="3"/>
  ...
  <labelOnTop>
    ...
    <field name="max_breach_depth" labelOnTop="0"/>
  </labelOnTop>
  <widgets/>
