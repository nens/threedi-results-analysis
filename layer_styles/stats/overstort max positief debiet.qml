...
<qgis version="2.14.6-Essen" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="v2_weir_view_stats_q_max">
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="v2_weir_view_stats_q_cumulative_duration">
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="v2_weir_view_stats_q_end">
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="v2_weir_view_stats_tot_vol_positive">
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="v2_weir_view_stats_tot_vol_negative">
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="v2_weir_view_stats_time_q_max">
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{9aaa9a55-01a0-4308-bb37-ca2f2f11bdb8}">
      <rule filter=" v2_weir_view_stats_q_max  >= -0.001 AND v2_weir_view_stats_q_max &lt;= 0.001" key="{8e1e0c55-6f54-44d5-91b3-1e289f3aab55}" symbol="0" label=" -0.001 - 0.001"/>
      <rule filter="v2_weir_view_stats_q_max > 0.001 AND  v2_weir_view_stats_q_max &lt;= 0.05 " key="{8b34da1d-93ce-4140-a1a6-d21cc0430364}" symbol="1" label=" 0.001 - 0.05"/>
      <rule filter="v2_weir_view_stats_q_max > 0.05 AND v2_weir_view_stats_q_max &lt;= 0.25" key="{509fdb35-0093-49da-9564-964687850c4e}" symbol="2" label=" 0.05 - 0.25 "/>
      <rule filter="v2_weir_view_stats_q_max > 0.25 AND v2_weir_view_stats_q_max &lt;= 1" key="{c608eff6-ca56-46d7-808b-85e1faa72fcd}" symbol="3" label=" 0.25 - 1 "/>
      <rule filter="v2_weir_view_stats_q_max > 1" key="{7d4e7b95-672d-4064-a2a4-11c30293d064}" symbol="4" label="> 1"/>
      <rule filter="v2_weir_view_stats_q_max > -0.05 AND v2_weir_view_stats_q_max &lt;= - 0.001" key="{4f8e37c4-d358-4099-a514-3bd3e9ce6aa1}" symbol="5" label=" -0.001 - -0.05"/>
      <rule filter="v2_weir_view_stats_q_max > -0.25 AND v2_weir_view_stats_q_max &lt;= -0.05" key="{2e902311-c509-4564-9338-4be59ab4dcc5}" symbol="6" label=" -0.05 - -0.25"/>
      <rule filter="v2_weir_view_stats_q_max > -1 AND v2_weir_view_stats_q_max &lt;= -0.25" key="{e1c3efa2-00dd-4ca1-a2c1-3865ccea377b}" symbol="7" label=" -0.25000 - -1"/>
      <rule filter="v2_weir_view_stats_q_max &lt; -1" key="{1b13b52b-e11c-41af-8e31-7f6e4ae06c3a}" symbol="8" label="&lt; -1"/>
    </rules>
    <symbols>
