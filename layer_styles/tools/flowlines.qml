...
<qgis version="2.14.1-Essen" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="flowline_idx">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="inp_id">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="splt_id">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 attr="type" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="v2_channel" label="v2_channel"/>
      <category render="true" symbol="1" value="v2_culvert" label="v2_culvert"/>
      <category render="true" symbol="2" value="v2_pumpstation" label="v2_pumpstation"/>
      <category render="true" symbol="3" value="v2_weir" label="v2_weir"/>
      <category render="true" symbol="4" value="0" label="0"/>
      <category render="true" symbol="5" value="v2_levee" label="v2_levee"/>
    ...
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="4">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="220,148,12,255"/>
          <prop k="line_style" v="solid"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="7">
        <layer pass="3" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="193,176,166,255"/>
          <prop k="line_style" v="solid"/>
    ...
    <source-symbol>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="147,170,213,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.26"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
