...
<qgis version="2.8.6-Wien" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="cross_section_definition_id">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{f00a4f8a-9ead-4fa9-8469-ac67948ddbab}">
      <rule filter="sewerage_type = 0" key="{6803b172-0ed4-4146-8a49-9bc2bd0d1ecc}" symbol="0" label="Gemengd"/>
      <rule filter="sewerage_type = 1" key="{e45e704c-c937-41ce-becf-d38ac3348d70}" symbol="1" label="RWA"/>
      <rule filter="sewerage_type = 2" key="{1f9ef154-6286-4b23-8963-728aa41de26b}" symbol="2" label="DWA"/>
      <rule filter="sewerage_type = 3" key="{1f528e71-6baa-4a8d-a489-ff6b5327dc67}" symbol="3" label="Transport"/>
      <rule filter="sewerage_type = 7" key="{3c94693d-4488-4be5-9f29-01130b1c9bd8}" symbol="4" label="Bergbezinkvoorziening"/>
      <rule filter="sewerage_type = 4 OR sewerage_type = 5 OR sewerage_type = 6 OR sewerage_type IS NULL" key="{44e6daab-06a7-4aac-a2ca-d1d69127d523}" symbol="5" label="Overig"/>
    </rules>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="invert_level_start_point || '\n' || invert_level_end_point"/>
