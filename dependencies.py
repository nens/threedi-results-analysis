...
DEPENDENCIES = [
    ...
    Dependency("threedi-schema", "threedi_schema", "==0.300.18", False),
    Dependency("threedi-modelchecker", "threedi_modelchecker", "==2.17.11", False),
    ...
    Dependency("threedi-mi-utils", "threedi_mi_utils", "==0.1.7", False),
    Dependency("hydxlib", "hydxlib", "==1.7.1", False),
]
