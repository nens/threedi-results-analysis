...
serie_settings = [
    {
        ...
        'items': [{
            ...
            'name': '2d: 1d-2d exchange',
            'default_method': 'gross',
            'order': 5,
            'def_fill_color': '205,220,5' + fill_transp,
            'def_pen_color': '205,220,5' + pen_transp,
            'series': ['2d__1d_2d_exch_in', '2d__1d_2d_exch_out'],
        },  {
            'name': '1d: 1d-2d flow',
            'default_method': 'gross',
            'order': 5.5,
            'def_fill_color': '250,22,150' + fill_transp,
            'def_pen_color': '250,22,150' + pen_transp,
            'series': ['1d__1d_2d_flow_in', '1d__1d_2d_flow_out'],
        }, {
            'name': '2d: 1d-2d flow',
            'default_method': 'gross',
            'order': 5.6,
            'def_fill_color': '210,255,140' + fill_transp,
            'def_pen_color': '210,255,140' + pen_transp,
            'series': ['2d__1d_2d_flow_in', '2d__1d_2d_flow_out'],
        }, {
            'name': 'pumps',
            'default_method': 'gross',
            'order': 6,
        ...
        'items': [{
            ...
            'series': ['1d__1d_2d_exch_in', '1d__1d_2d_exch_out',
                       '2d__1d_2d_exch_in', '2d__1d_2d_exch_out'],
        }, {
            'name': 'volume change',
            'default_method': 'net',
            'order': 5,
