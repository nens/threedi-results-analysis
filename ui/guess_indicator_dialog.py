...
class Ui_Import_dialog(object):
    def setupUi(self, Import_dialog):
        ...
        self.check_pipe_friction.setObjectName(_fromUtf8("check_pipe_friction"))
        ...
        self.check_only_empty_fields.setObjectName(_fromUtf8("check_only_empty_fields"))
        ...
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("accepted()")), Import_dialog.accept)
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("rejected()")), Import_dialog.reject)
    ...
    def retranslateUi(self, Import_dialog):
        ...
        self.groupBox_2.setTitle(_translate("Import_dialog", "Model schematisation database", None))
        ...
        self.checkBox_3.setText(_translate("Import_dialog", "Manhole indicator", None))
