...
class TestStatistics(unittest.TestCase):
    ...
    def setUpClass(cls, mock_pop_up_question, mock_progress_bar):
        ...
        dummy.sqlite_gridadmin_filepath = monkey_patch_return_tmp_path

        cls.stat = StatisticsTool(None, dummy)
        # check that path of gridadmin.sqlite is correctly update to the tmp path
        assert cls.stat.ts_datasources.sqlite_gridadmin_filepath() == tmp_filename_path
    ...
    def test_flowline_stats_view(self):
        resultdb_path = self.stat.ts_datasources.sqlite_gridadmin_filepath()
