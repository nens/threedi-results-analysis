...
<qgis simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyDrawingHints="1" maxScale="0" labelsEnabled="0" readOnly="0" hasScaleBasedVisibilityFlag="0" minScale="1e+08" simplifyLocal="1" version="3.4.12-Madeira">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 type="graduatedSymbol" attr="(rain_depth_sum)-(infiltration_rate_mm_sum + intercepted_volume_mm_last)" forceraster="0" symbollevels="0" enableorderby="0" graduatedMethod="GraduatedColor">
    <ranges>
      <range label="-63 - -50" upper="-50.402221921555977" render="true" lower="-63.002777401944975" symbol="0"/>
      <range label="-50 - -38" upper="-37.801666441166979" render="true" lower="-50.402221921555977" symbol="1"/>
      <range label="-38 - -25" upper="-25.201110960777982" render="true" lower="-37.801666441166979" symbol="2"/>
      <range label="-25 - -13" upper="-12.600555480388984" render="true" lower="-25.201110960777982" symbol="3"/>
      <range label="-13 - 0" upper="0.000000000000014" render="true" lower="-12.600555480388984" symbol="4"/>
      <range label="0 - 13" upper="12.600555480389012" render="true" lower="0.000000000000014" symbol="5"/>
      <range label="13 - 25" upper="25.201110960778003" render="true" lower="12.600555480389012" symbol="6"/>
      <range label="25 - 38" upper="37.801666441167008" render="true" lower="25.201110960778003" symbol="7"/>
      <range label="38 - 50" upper="50.402221921556013" render="true" lower="37.801666441167008" symbol="8"/>
      <range label="50 - 63" upper="63.002777401944975" render="true" lower="50.402221921556013" symbol="9"/>
    </ranges>
    <symbols>
      ...
      <symbol alpha="1" type="fill" clip_to_extent="1" name="1" force_rhr="0">
        <layer class="SimpleFill" enabled="1" pass="0" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="155,101,174,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" type="fill" clip_to_extent="1" name="2" force_rhr="0">
        <layer class="SimpleFill" enabled="1" pass="0" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="186,152,201,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" type="fill" clip_to_extent="1" name="3" force_rhr="0">
        <layer class="SimpleFill" enabled="1" pass="0" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="212,193,221,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" type="fill" clip_to_extent="1" name="4" force_rhr="0">
        <layer class="SimpleFill" enabled="1" pass="0" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="236,229,239,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" type="fill" clip_to_extent="1" name="5" force_rhr="0">
        <layer class="SimpleFill" enabled="1" pass="0" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="229,241,228,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" type="fill" clip_to_extent="1" name="6" force_rhr="0">
        <layer class="SimpleFill" enabled="1" pass="0" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="193,229,189,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" type="fill" clip_to_extent="1" name="7" force_rhr="0">
        <layer class="SimpleFill" enabled="1" pass="0" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="148,210,148,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
    ...
    <rotation/>
    <sizescale/>
    <labelformat format="%1 - %2" decimalplaces="0" trimtrailingzeroes="false"/>
  </renderer-v2>
  <customproperties>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory lineSizeScale="3x:0,0,0,0,0,0" scaleDependency="Area" barWidth="5" sizeType="MM" lineSizeType="MM" penWidth="0" minScaleDenominator="0" sizeScale="3x:0,0,0,0,0,0" enabled="0" diagramOrientation="Up" rotationOffset="270" labelPlacementMethod="XHeight" backgroundColor="#ffffff" penColor="#000000" maxScaleDenominator="1e+08" scaleBasedVisibility="0" backgroundAlpha="255" penAlpha="255" width="15" opacity="1" height="15" minimumSize="0">
      <fontProperties description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style=""/>
      <attribute color="#000000" label="" field=""/>
    </DiagramCategory>
  </SingleCategoryDiagramRenderer>
  <DiagramLayerSettings placement="1" linePlacementFlags="18" priority="0" obstacle="0" showAll="1" dist="0" zIndex="0">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="infiltration_rate_mm_sum">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="intercepted_volume_mm_last">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="spatialite_id"/>
  </editable>
  <labelOnTop>
