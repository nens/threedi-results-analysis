...
<qgis version="2.18.12" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="perc_max_discharge">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="perc_max_discharge" forceraster="0" symbollevels="0" type="graduatedSymbol" graduatedMethod="GraduatedColor" enableorderby="0">
    <ranges>
      <range render="true" symbol="0" lower="0.000000000000000" upper="1.000000000000000" label=" 0 - 1 "/>
      <range render="true" symbol="1" lower="1.000000000000000" upper="25.000000000000000" label=" 1 - 25 "/>
      <range render="true" symbol="2" lower="25.000000000000000" upper="50.000000000000000" label=" 25 - 50 "/>
      <range render="true" symbol="3" lower="50.000000000000000" upper="99.000000000000000" label=" 50 - 99"/>
      <range render="true" symbol="4" lower="99.000000000000000" upper="100.099999999999994" label=" 99 - 100"/>
    </ranges>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="q" index="5" name=""/>
    <alias field="capacity" index="6" name=""/>
    <alias field="q_percentage" index="7" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="q_percentage"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    <default field="perc_max_discharge" expression=""/>
  </defaults>
