...
<qgis version="2.18.12" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="duration_pump_on_max">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="duration_pump_on_max" forceraster="0" symbollevels="0" type="graduatedSymbol" graduatedMethod="GraduatedColor" enableorderby="0">
    <ranges>
      <range render="true" symbol="0" lower="0.000000000000000" upper="1.000000000000000" label=" 0 - 1 "/>
      <range render="true" symbol="1" lower="1.000000000000000" upper="2.000000000000000" label=" 1 - 2 "/>
      <range render="true" symbol="2" lower="2.000000000000000" upper="4.000000000000000" label=" 2 - 4 "/>
      <range render="true" symbol="3" lower="4.000000000000000" upper="8.000000000000000" label=" 4 - 8 "/>
      <range render="true" symbol="4" lower="8.000000000000000" upper="1000.000000000000000" label="> 8"/>
    </ranges>
    <symbols>
    ...
    <source-symbol>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="182,109,194,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
  ...
  <aliases>
    ...
    <alias field="pumped_volume" index="5" name=""/>
    <alias field="capacity" index="6" name=""/>
    <alias field="pump_max_duration" index="7" name=""/>
    <alias field="percentage_pumps" index="8" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="pumped_volume"/>
      <column width="-1" hidden="0" type="field" name="capacity"/>
      <column width="-1" hidden="0" type="field" name="pump_max_duration"/>
      <column width="-1" hidden="0" type="field" name="percentage_pumps"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    <default field="duration_pump_on_max" expression=""/>
  </defaults>
