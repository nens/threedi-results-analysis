...
<qgis version="2.18.12" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="duration_water_on_surface">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="duration_water_on_surface" forceraster="0" symbollevels="0" type="graduatedSymbol" graduatedMethod="GraduatedColor" enableorderby="0">
    <ranges>
  ...
  <aliases>
    ...
    <alias field="max_waterlevel" index="6" name=""/>
    <alias field="wos_duration" index="7" name=""/>
    <alias field="wos_height" index="8" name=""/>
    <alias field="waterdiepte" index="9" name=""/>
    <alias field="sewerage_type" index="10" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="max_waterlevel"/>
      <column width="-1" hidden="0" type="field" name="wos_duration"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    <default field="duration_water_on_surface" expression=""/>
  </defaults>
