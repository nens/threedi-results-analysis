...
<qgis version="2.18.12" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="end_filling">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="end_filling" forceraster="0" symbollevels="1" type="graduatedSymbol" graduatedMethod="GraduatedColor" enableorderby="0">
    <ranges>
  ...
  <aliases>
    ...
    <alias field="manhole_id" index="7" name=""/>
    <alias field="display_name" index="8" name=""/>
    <alias field="bottom_level" index="9" name=""/>
    <alias field="surface_level" index="10" name=""/>
    <alias field="wos_height" index="11" name=""/>
    <alias field="waterdiepte" index="12" name=""/>
    <alias field="perc_vulling" index="13" name=""/>
  </aliases>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    <default field="end_filling" expression=""/>
  </defaults>
