...
<qgis version="2.18.12" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="max_waterdepth_surface">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{b137d597-35bb-48f3-9c49-7adda36b2ab9}">
      <rule filter="max_waterdepth_surface &lt;= 0" key="{58ec8abb-f77a-48db-9461-42598f351046}" symbol="0" label="&lt; 0"/>
      <rule filter="max_waterdepth_surface > 0" key="{6ff6c0d0-dd45-469a-b8f3-213a7a00d568}" symbol="1" label="> 0"/>
    </rules>
    <symbols>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    <default field="max_waterdepth_surface" expression=""/>
  </defaults>
